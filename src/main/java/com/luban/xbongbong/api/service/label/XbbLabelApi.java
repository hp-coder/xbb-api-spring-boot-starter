...
public class XbbLabelApi {
    ...
    public static List<XbbFormLabelResponse.LabelGroup> formLabels(
        ...
        final XbbResponse<XbbFormLabelResponse> xbbResponse = XbbApiCaller.call(Label.LIST, data);
    ...
    public static boolean add(@NonNull XbbAddLabelModel model) {
        final XbbResponse<Void> xbbResponse = XbbApiCaller.call(Label.BATCH_ADD, model.json());
    ...
    public static boolean remove(@NonNull XbbRemoveLabelModel model) {
        final XbbResponse<Void> xbbResponse = XbbApiCaller.call(Label.REMOVE, model.json());
        return xbbResponse.succeed();
    }
